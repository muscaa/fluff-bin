...
import fluff.functions.gen.TIntFunc;
import fluff.functions.gen._int.TVoidFunc1Int;
...
public class Binary {
     ...
     */
    public static boolean Boolean(TIntFunc<IOException> readNext) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static byte Byte(TIntFunc<IOException> readNext) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static char Char(TIntFunc<IOException> readNext) throws IOException {
        return (char) (
     ...
     * @throws IOException if an I/O error occurs
     */
    public static short Short(TIntFunc<IOException> readNext) throws IOException {
        return (short) (
                (readNext.invoke() & 0xFF) <<  8 |
                (readNext.invoke() & 0xFF)
                );
     ...
     * @throws IOException if an I/O error occurs
     */
    public static int Int(TIntFunc<IOException> readNext) throws IOException {
        return (int) (
     ...
     * @throws IOException if an I/O error occurs
     */
    public static float Float(TIntFunc<IOException> readNext) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static long Long(TIntFunc<IOException> readNext) throws IOException {
        return (long) (
     ...
     * @throws IOException if an I/O error occurs
     */
    public static double Double(TIntFunc<IOException> readNext) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static String LenString(TIntFunc<IOException> readNext) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static String String(TIntFunc<IOException> readNext, int length) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static byte[] LenBytes(TIntFunc<IOException> readNext) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static byte[] Bytes(TIntFunc<IOException> readNext, int length) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void Boolean(TVoidFunc1Int<IOException> writeNext, boolean value) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void Byte(TVoidFunc1Int<IOException> writeNext, byte value) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void Char(TVoidFunc1Int<IOException> writeNext, char value) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void Short(TVoidFunc1Int<IOException> writeNext, short value) throws IOException {
    	writeNext.invoke((value >>  8) & 0xFF);
    	writeNext.invoke((value      ) & 0xFF);
    }
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void Int(TVoidFunc1Int<IOException> writeNext, int value) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void Float(TVoidFunc1Int<IOException> writeNext, float value) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void Long(TVoidFunc1Int<IOException> writeNext, long value) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void Double(TVoidFunc1Int<IOException> writeNext, double value) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void LenString(TVoidFunc1Int<IOException> writeNext, String value) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void String(TVoidFunc1Int<IOException> writeNext, String value, int length) throws IOException {
        for (int i = 0; i < length; i++) {
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void LenBytes(TVoidFunc1Int<IOException> writeNext, byte[] value) throws IOException {
        Int(writeNext, value.length);
     ...
     * @throws IOException if an I/O error occurs
     */
    public static void Bytes(TVoidFunc1Int<IOException> writeNext, byte[] value, int length) throws IOException {
    	for (int i = 0; i < length; i++) {
